function [avgCoords, elecNames, isLeft]=depths2AvgBrain_Chao_BR(dirs)
...
ptntCoordFile=fullfile(subDir,'elec_recon_BR',[subj '.CT_BR']);
...
elecNamesFile=fullfile(subDir,'elec_recon_BR',[subj '.electrodeNames_BR']);
